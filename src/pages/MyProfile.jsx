...
//                 className="py-2 px-4 border border-gray-300 rounded-lg text-gray-700 font-semibold hover:bg-gray-50 transition duration-150"
//                 disabled={isLoading}
//               >
//                 Cancel
//               </button>
//               <button
//                 type="submit"
//                 className="py-2 px-6 bg-teal-600 text-white font-semibold rounded-lg shadow-md hover:bg-teal-700 transition duration-150 disabled:opacity-50"
//                 disabled={isLoading}
//               >
...
//   return (
//     <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6">
//       <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden transform transition duration-500 hover:shadow-2xl">
...
//           </h2>
//           <p className="text-lg text-gray-500 mb-6 font-medium">{user.email}</p>
...
//                 <span className="text-teal-600 font-bold">Jan 2024</span>
//               </div>
//             </div>
...
//                 setIsUpdating(true);
//               }}
//               className="w-full py-3 text-lg font-bold bg-teal-600 text-white rounded-xl shadow-lg hover:bg-teal-700 transition duration-300 transform hover:scale-[1.01] cursor-pointer"
//             >
//               Update Profile
//             </button>
//           </div>
